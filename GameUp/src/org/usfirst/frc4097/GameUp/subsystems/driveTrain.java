...
public class driveTrain extends Subsystem {
    ...
    public void takeJoystick(Joystick main){
    	...
    	//if (main.getX()!=0 || main.getY()!=0){
    	differentialDrive.arcadeDrive(main.getX()*(0.7-0.2*f), main.getY()*(0.65-0.15*f));
    	//}
    	//else if(main.getZ()!=0 || main.getY()!=0){
    		//differentialDrive.arcadeDrive(main.getZ()*(0.65*f), main.getY()*(0.6-0.1*f));
    	//}
