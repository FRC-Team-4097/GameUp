...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("toSwitchCenter", new toSwitchCenter());
        SmartDashboard.putData("driveForward", new driveForward());
        SmartDashboard.putData("toSwitchLeft", new toSwitchLeft());
        SmartDashboard.putData("toSwitchRight", new toSwitchRight());
